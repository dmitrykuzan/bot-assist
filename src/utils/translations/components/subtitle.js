export const subtitle = {
  ...
  ru: {
    ...
    thankYou:
      "Спасибо! Ваша форма отправлена. Мы свяжемся с вами в ближайшее время.",
    detected:
      "Мы обнаружили, что ваша страна — Франция. Хотите продолжить на французском?",
    supportConsult:
      "В это время {{вы можете приобрести лицензию}} через нашего консультанта службы поддержки.",
    allPlans:
      "Мы готовим понятное и удобное руководство по всем тарифам нашего приложения и лицензии Bitrix24.",
    directly: "Заполните форму, и наши консультанты свяжутся с вами напрямую.",
    queryLimit:
      "Похоже, вы достигли лимита запросов! Чтобы продолжить, вы можете либо увеличить лимиты плана, либо записаться на консультацию с одним из наших специалистов.",
    synchCardDav:
      "Синхронизация через CardDAV является односторонней: от Bitrix24 к устройству.",
    thirdParty:
      "Для синхронизации контактов на Android могут потребоваться сторонние приложения из Google Play.",
    following:
      "Настройте синхронизацию на вашем устройстве Apple, следуя инструкциям на странице «Настройки синхронизации» или «Сотрудники».",
    synchDefault:
      "Если устройство не указывает коллекцию для синхронизации (часто на macOS), используйте опцию «Синхронизировать по умолчанию».",
    crmCompanies:
      "Компании CRM: Выберите «Мои» или «Все» и укажите количество.",
    systemUser:
      "Системные пользователи: Коллеги из отделов вашей компании. Вы можете выбрать несколько отделов, используя Ctrl (или Command на macOS).",
    security: "Перейдите в раздел «Безопасность».",
    cardDav:
      "Синхронизация через протокол CardDAV является односторонней: от Bitrix24 к устройству. Вот краткое описание, как настроить синхронизацию контактов в Bitrix24 через CardDAV:",
    bitrixSupport:
      "Здравствуйте! Bitrix24 поддерживает синхронизацию контактов с вашим мобильным телефоном через протокол CardDAV. Устройства Apple, такие как iPhone, iPad и Mac, нативно поддерживают CardDAV. Для синхронизации контактов на устройствах Android вам, скорее всего, понадобятся сторонние приложения, доступные в Google Play.",
    synchronize:
      "Здравствуйте! Как мне синхронизировать мои контакты (клиентов), а не сотрудников портала, с Android?",
    guidance: "Включает промежуточную поддержку и руководство по функциям CRM.",
    getLicense: "Получите лицензию CRM + Бесплатный чат-бот PRIME",
    help: "Я здесь, чтобы ответить на ваши вопросы, помочь с настройкой и предложить идеи для улучшения работы с CRM.",
    demonstration:
      "Если вы хотите получить консультацию с одним из наших специалистов (онлайн-сессия продолжительностью 1-2 часа, где вы получите ответы и демонстрацию системы, связанную с вашим вопросом или другими темами CRM), пожалуйста, запишитесь на консультацию.",
    needHelp:
      "Нужна помощь с настройкой или требованиями? Найдите все руководства, документы и поддержку, которые вам нужны, в кратчайшие сроки.",
  },
};
